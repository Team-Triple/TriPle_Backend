...
public class BucketKeyPublisher {
    ...
    public String publishPendingKey(String fileName, Long userId) {
        ...
        return s3BucketProperties.getPrefix().getPending() + userId + "/" + getUUID() + "." + extension;
    }
    ...
    public String publishUploadedKey(String pendingKey) {
        ...
        String pendingPrefix = s3BucketProperties.getPrefix().getPending();
        String uploadedPrefix = s3BucketProperties.getPrefix().getUploaded();
